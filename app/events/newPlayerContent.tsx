...
export const newPlayerInfo: InfoItem[] = [
    {
        ...
        content: (
            <div>
                ...
                <h3>New to Our Tournaments? Let's Get You Rated!</h3>
                <p>
                ...
                <h3>Already using the Bullshooter App?</h3>
                <p>
