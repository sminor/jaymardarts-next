...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, content, className = '' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        className={`relative z-50 w-full max-w-screen-xl ${className} p-6 rounded-lg shadow-xl bg-[var(--modal-background)] bg-opacity-95 mx-4 mt-4 max-h-[90vh] overflow-y-auto`}
